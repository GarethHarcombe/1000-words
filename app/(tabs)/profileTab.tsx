...
const styles = StyleSheet.create({
  container: { backgroundColor: Colors.light.background, paddingTop: 60, paddingBottom: 40, paddingHorizontal: 20, alignItems: 'center', gap: 16 },
  card: { width: '100%', backgroundColor: Colors.light.background, borderRadius: 12, padding: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 4 },
  cardTitle: { fontSize: 20, fontWeight: 'bold', color: Colors.light.text },
  cardSubtitle: { fontSize: 14, color: Colors.light.subtitle, marginBottom: 8 },
  caravanRow: { width: '100%', alignItems: 'center', justifyContent: 'center', paddingVertical: 8, minHeight: 200 },
  button: { marginTop: 8, height: 56, borderRadius: 28, width: '80%', maxWidth: 350, alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.light.tint, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.25, shadowRadius: 4, elevation: 4 },
